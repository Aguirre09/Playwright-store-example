...
test.describe('LogOut SauceDemo', () => {
  ...
  test('LogOut', async ({ Given, When, Then, And, page }) => { 
    ...
    await Then('Deberia ver el titulo del boton "Swag Labss"', null, { page }); 
  });
