...
test.describe('Login SauceDemo', () => {
  ...
  test('Login exitoso', { tag: ['@login'] }, async ({ Given, When, Then, And, page }) => { 
    ...
    await Then('Deberia ver el titulo "Products"', null, { page }); 
  });
