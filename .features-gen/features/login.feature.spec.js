...
test.describe('Login SauceDemo', () => {
  ...
  test('Login exitoso', async ({ Given, When, Then, And, page }) => { 
    ...
    await Then('Deberia ver el titulo "Productos"', null, { page }); 
  });
